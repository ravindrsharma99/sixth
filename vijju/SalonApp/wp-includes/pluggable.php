 ...
 */
function wp_new_booking_barber_notification( $user_id,$barber_id,$time_slot,$slot_date,$transaction_id) {
	
	$user = get_userdata( $user_id );
	$barber = get_userdata( $barber_id );
	$message = '<head>
...
<table width="60%" border="0" bgcolor="#04caa9" style="margin:0 auto; float:none;font-family: Open Sans, sans-serif; padding:0 0 10px 0;">
  <tr>
    <th width="20px"></th>
    <th style="padding-top:30px;padding-bottom:30px;"> <img src="http://phphosting.osvin.net/BarberOnline/api/logo2.png"></th>
       <th width="20px"></th>
  </tr>
  <tr>
    <td width="20px"></td>
...
<table width="100%;">
  <tr>
    <th style="font-size:20px; font-weight:bolder; text-align:left;padding-bottom:10px;border-bottom:solid 1px #ddd;">Dear '.$user->display_name.'</th>
  </tr>
  <tr>
...
<th style="border:solid 1px #aee3da;color:black">Customer Name</th>
<th style="border:solid 1px #aee3da;color:black">Barber Name</th>
...
<td style="border:solid 1px #aee3da;">'.$user->display_name.'</td>
<td style="border:solid 1px #aee3da;">'.$barber->display_name.'</td>
</tr>  
</table>
</td>
  </tr>
<tr><td>You can review your Booking details, cancel your Booking or reschedule by going to the <b>My Bookings</b> section of your Barber Online app.</td></tr>
  <tr>
<tr><td><b>Please Note: Bookings may be canceled without any charges up to 24 hours prior to the scheduled start time of the Booking.</b></td></tr>
...
&bull; We recommend that you open your Barber Online app a few minutes before your Booking is scheduled to begin.<br>
&bull; Connect to WiFi to ensure a stronger connection.</td></tr>
<tr><td><b>Computer Visit:</b><br>
&bull; You must log in at Salon app a few minutes before your Booking begins.<br>
&bull; Be sure you are connected to a strong Internet connection.</td></tr> 
<tr><td>At the start of your Booking you initiate your Video Visit. Just click Start button as it becomes active.</td></tr>
...
<h2 style="margin:0; font-weight:100;">Barber Online Team<br>
http://phphosting.osvin.net/BarberOnline/testdocotorinsta/<br>
osvin315@gmail.com</h2>
   ...
   <tr>
    <td width="20px"></td>
    <td style="text-align:center; color:#fff; padding:10px;"> Copyright ©'.date("Y").' Barber Online All Rights Reserved</td>
    <td width="20px"></td>
  </tr>
</table>';
	...
	// send email
	wp_mail($user->user_email, sprintf(__('[%s] Booking info'), $user->display_name), $message,$headers);
}
function wp_new_booking_user_notification( $user_id,$barber_id,$time_slot,$slot_date,$transaction_id) {
...
<th style="border:solid 1px #aee3da;color:black">Customer Name</th>
<th style="border:solid 1px #aee3da;color:black">Barber Name</th>
<th style="border:solid 1px #aee3da;color:black">Transaction</th>
...
<td style="border:solid 1px #aee3da;">'.$user->display_name.'</td>
<td style="border:solid 1px #aee3da;">'.$barber->display_name.'</td>
<td style="border:solid 1px #aee3da;">'.$transaction_id.'</td>
</tr>  
</table>
</td>
  </tr>
...
function wp_new_app_user_notification($user_id,$userPass) {
...
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,600' rel='stylesheet' type='text/css'>
	...
	<body>		
<table width=60% border=0 bgcolor=#1e6b95 style=margin:0 auto; float:none;font-family: 'Open Sans', sans-serif; padding:0 0 10px 0;>
  <tr>
    <th width=20px></th>
    <th style=padding-top:30px;padding-bottom:30px;><img src='/takeatask/Admin/img/logo.png' /></th>
       <th width=20px></th>
  </tr>
  <tr>
    <td width=20px></td>
...
<table width=100%;>
  <tr>
    <th style=font-size:20px; font-weight:bolder; text-align:right;padding-bottom:10px;border-bottom:solid 1px #ddd;> Hello ".$user->display_name."</th>
  </tr>
 
  <tr>
    <td style=font-size:16px;>
    <p>Congratulations! You have successfully completed the registration at Salon app. Thank you for signing up with Take A Task. We are excited to have you as a member of Take A Task.</p>
    <p>Please find below the login information for your account.</p>
	<p><b>User ID-:</b>".$user->user_login."</p>
	<p><b>Password-:</b>".$userPass."</p>
	<p>Please keep it secret, keep it safe!</p>
	<p>But You still are not able to login please wait for Approval!</p>
	<p>You Get an Email after Approval of your account</p>
	<p>If you have any queries or concerns, please do not hesitate to contact us.</p>
    </td>
  </tr>
  <tr>
...
<h3 style=margin:0; font-weight:100;>Salon app</h3>
</td>
  </tr>
   ...
   <tr>
    <td width=20px></td>
  	<td style=text-align:center; color:#fff; padding:10px;> Copyright © Salon app All Rights Reserved</td>
    <td width=20px></td>
  </tr>
    ...
    // $headers = 'From: info@babysharelove.com' . "\r\n" .
    //         'Reply-To: info@babysharelove.com' . "\r\n" .
    //         'X-Mailer: PHP/' . phpversion();
    $headers = 'MIME-Version: 1.0' . "\r\n";
    $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
	// send email
		//mail($user->user_email,"My subject",$message);
