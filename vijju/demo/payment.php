...
<html>
    <head>
        ...
        <!-- BASE CSS -->
        <link href="http://d3tdtxjimlvchf.cloudfront.net/test/foodsaholic/home/css/base.css" rel="stylesheet">

        <!-- Radio and check inputs -->
        <link href="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/home/css/skins/square/grey.css" rel="stylesheet">
        <!-- Modernizr -->
        <script src="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/home/js/modernizr.js"></script> 
...
<!--        <header>
            <div class="container-fluid">
                <div class="row">
                    <div class="col--md-4 col-sm-4 col-xs-4">
                        <a href="/test/foodsaholic/" id="logo">
                            <img src="/test/foodsaholic/home/img/logo.png" width="120" alt="" data-retina="true" class="hidden-xs">
                            <img src="/test/foodsaholic/home/img/logo_mobile.png" width="120" alt="" data-retina="true" class="hidden-lg hidden-md hidden-sm">
                        </a>
                    </div>
                    <nav class="col--md-8 col-sm-8 col-xs-8">
                        ...
                        <div class="main-menu">
                            <div id="header_menu">
                                <img src="/test/foodsaholic/home/img/logo.png" width="120" alt="" data-retina="true">
                            </div>
                            <a href="#" class="open_close" id="close_in"><i class="icon_close"></i></a>
                            <ul>
                                <li><a href="/test/foodsaholic/">Home</a></li>
                                ...
                                <li><a href="/test/foodsaholic/pages/about">About Us</a></li>   
    ...
    <link rel="stylesheet" type="text/css" href="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/css/payfort/fontello.css?1486532502"/>

    <link rel="stylesheet" type="text/css" href="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/css/payfort/normalize.css?1486532494"/>

    <link rel="stylesheet" type="text/css" href="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/css/payfort/style.css?1486532490"/>

    <script type="text/javascript" src="http://d3tdtxjimlvchf.cloudfront.net/test/foodsaholic/js/payfort/jquery.min.js?1486535587"></script>
 ...
 <!--section class="actions" style="margin: 0;">
     <a style="margin: 0px auto; float: none;" class="back" id="btn_back" href="">Back</a>
    </section-->
 
    <script type="text/javascript" src="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/js/payfort/checkout.js?1490617685"></script>

    <script type="text/javascript" src="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/js/payfort/jquery.creditCardValidator.js?1486532595"></script>
...
<!--        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-3">
                        ...
                        <p>
                            <img src="/test/foodsaholic/home/img/cards.png" alt="" class="img-responsive">
                        </p>
                    </div>
        ...
        <div class="modal fade" id="login_2" tabindex="-1" role="dialog" aria-labelledby="myLogin" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content modal-popup">
                    ...
                    <form action="/test/foodsaholic/users/login" method="post"class="popup-form" id="myLogin">
                        ...
                        <input type="hidden" name="data[User][server]" value="foodsaholic.com/test/foodsaholic/eng/payments/conferm?payment_method=cc_merchantpage">
                        <div class="text-left">
                            <a href="/test/foodsaholic/users/forgetpwd">Forgot Password?</a>
                        </div>
        ...
        <div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="myRegister" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content modal-popup">
                    <a href="#" class="close-link"><i class="icon_close_alt2"></i></a>
                    <form action="/test/foodsaholic/users/add" class="popup-form" method="post" id="myRegister">
                        <div class="login_icon"><i class="icon_lock_alt"></i></div>
        ...
        <!-- COMMON SCRIPTS -->
        <script src="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/home/js/jquery-1.11.2.min.js"></script>
        <script src="http://d3tdtxjimlvchf.cloudfront.net/test/foodsaholic/home/js/common_scripts_min.js"></script>
        <script src="http://d3tdtxjimlvchf.cloudfront.net/test/foodsaholic/home/js/functions.js"></script>
        <script src="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/home/assets/validate.js"></script>
        <script src="http://maps.googleapis.com/maps/api/js"></script>
        <script src="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/home/js/map.js"></script>
        <script src="http://d3tdtxjimlvchf.cloudfront.net/test/foodsaholic/home/js/infobox.js"></script>
        <script src="http://d1ag6ckypndv2d.cloudfront.net/test/foodsaholic/home/js/addtocart.js"></script>
        <!-- SPECIFIC SCRIPTS -->
        <script src="http://d3tdtxjimlvchf.cloudfront.net/test/foodsaholic/home/js/video_header.js"></script>
    ...
    <script type="text/javascript">
        ...
        $('#nwsltr').on("click", function () {
            ...
            else
            {
                ...
                $.ajax({
                    url: 'http://rajdeep.crystalbiltech.com/foodolik/shop/newsletter',
