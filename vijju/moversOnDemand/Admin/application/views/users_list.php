			...
			if (result) {
				...
				$.ajax({
					...
					success: function(response) {
						...
						{
							window.location.href = '<?php echo base_url('Dashboard/user_list')?>';
                    //  // $(".normal").css({"background-color":"#FF0000"});
                    //  //  $(".usercommercial").html("Normal121");
                    //    // $(".normal"+id).slideUp(100, function() {
                    //   $("#change"+id).css({"background-color":"#FF00040"});
                    //  $("#change"+id).html("Normal");
                    // // });
